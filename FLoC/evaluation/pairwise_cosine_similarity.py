...
import numpy as np
from FLoC.evaluation.anonymity_evaluation import compute_cluster_centroid, average_cosine_similarity, normalize_matrix_for_cosine_similarity, reconstruct_training_user_movie_rating
...
from FLoC.evaluation.pipeline import compute_standard_deviation, compute_average_common_movie_counts
...
if __name__ == '__main__':
    ...
    root_path = f'{script_dirpath}/saved/cluster_assignments'
